...
from ..core import GUICoordinator, get_next_window_id, register_window, unregister_window
from ..custom_widgets import ScrollableComboBox
from ..emoji_renderer import prepare_emoji_content
from ..platform import HAVE_CTK, ctk
from ..popups import CarouselButtonList, GroupedButtonList, ModifierBar, SegmentedToggle, Tooltip
...
class AudioAnalyzerWindow:
        ...
        try:
            ...
            if self.current_device:
                ...
                if self.recorder.start_stream(level_callback=callback):
                    ...
                    logging.error("[AudioAnalyzer] Failed to start stream")
    ...
    def _save_audio(self):
        ...
        from ...audio.export import build_output_filename, export_audio_from_file, get_format_ext
        from ...audio.recorder import COMPRESSION_PRESETS
