...
class GeminiNativeProvider(BaseProvider):
    ...
    def __init__(self, key_manager=None, config: Optional[Dict] = None, base_url: Optional[str] = None):
        """
    ...
    def upload_file(self, filepath: Path, display_name: Optional[str] = None) -> Tuple[Optional[gemini_services.UploadedFile], Optional[str]]:
