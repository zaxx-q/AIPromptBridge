...
def build_text_message(task: str, system_prompt: str) -> List[Dict[str, Any]]:
    """
...
def build_audio_message(audio_b64: str, mime_type: str, task: str, system_prompt: str) -> List[Dict[str, Any]]:
    """
    ...
    return [
        {"role": "system", "content": system_prompt},
        {
            "role": "user",
            "content": [
                {"type": "inline_data", "inline_data": {"mime_type": mime_type, "data": audio_b64}},
                {"type": "text", "text": task},
            ],
        },
    ]
...
def build_image_message(image_b64: str, mime_type: str, task: str, system_prompt: str) -> List[Dict[str, Any]]:
    """
    ...
    return [
        ...
        {
            "role": "user",
            "content": [{"type": "image_url", "image_url": {"url": data_url}}, {"type": "text", "text": task}],
        },
    ]


def build_comparison_message(
    image1_b64: str, image2_b64: str, mime_type: str, task: str, system_prompt: str
) -> List[Dict[str, Any]]:
    """
...
def build_text_comparison_message(text1: str, text2: str, task: str, system_prompt: str) -> List[Dict[str, Any]]:
    """
    ...
    messages.append(
        {
            "role": "user",
            "content": [
                {"type": "inline_data", "inline_data": {"mime_type": mime_type, "data": data_b64}},
                {"type": "text", "text": task},
            ],
        }
    )
