...
ROSE_DARK = ThemeColors(
    ...
    accent="#e8879c",
    accent_green="#8ec99c",
    accent_yellow="#e8c87a",
    accent_red="#e05573",
    user_bg="#352535",
    user_accent="#e8879c",
    assistant_bg="#253028",
    assistant_accent="#8ec99c",
    code_bg="#1f1822",
    header1="#e8c87a",
    header2="#e8879c",
    header3="#c490d4",
...
ROSE_LIGHT = ThemeColors(
    ...
    accent="#c8506a",
    accent_green="#3d9455",
    accent_yellow="#c08820",
    accent_red="#c03050",
    user_bg="#f0e0e8",
    user_accent="#c8506a",
    assistant_bg="#e0f0e5",
    assistant_accent="#3d9455",
    code_bg="#f0e5ea",
    header1="#c08820",
    header2="#c8506a",
    header3="#8855a0",
...
COFFEE_DARK = ThemeColors(
    ...
    accent="#c89060",
    accent_green="#8eb87a",
    accent_yellow="#d4b060",
    accent_red="#c86050",
    user_bg="#2c2218",
    user_accent="#c89060",
    assistant_bg="#222c1e",
    assistant_accent="#8eb87a",
    code_bg="#161210",
    header1="#d4b060",
    header2="#c89060",
    header3="#a0886c",
...
COFFEE_LIGHT = ThemeColors(
    ...
    accent="#8c5c3a",
    accent_green="#5a8840",
    accent_yellow="#a07828",
    accent_red="#a84030",
    user_bg="#eaddd0",
    user_accent="#8c5c3a",
    assistant_bg="#e0ecd8",
    assistant_accent="#5a8840",
    code_bg="#ece2d8",
    header1="#a07828",
    header2="#8c5c3a",
    header3="#6a5040",
...
VIOLET_DARK = ThemeColors(
    ...
    accent="#9880d0",
    accent_green="#80b890",
    accent_yellow="#d0b870",
    accent_red="#d06070",
    user_bg="#282440",
    user_accent="#9880d0",
    assistant_bg="#1e3028",
    assistant_accent="#80b890",
    code_bg="#141224",
    header1="#d0b870",
    header2="#9880d0",
    header3="#7898d0",
...
VIOLET_LIGHT = ThemeColors(
    ...
    accent="#6848a8",
    accent_green="#408850",
    accent_yellow="#a08018",
    accent_red="#b83848",
    user_bg="#e8e0f4",
    user_accent="#6848a8",
    assistant_bg="#e0f0e4",
    assistant_accent="#408850",
    code_bg="#ece6f4",
    header1="#a08018",
    header2="#6848a8",
    header3="#4868a0",
...
class ThemeRegistry:
    ...
    _themes: ClassVar[Dict[str, tuple]] = {
        ...
        "rose": (ROSE_DARK, ROSE_LIGHT),
        "coffee": (COFFEE_DARK, COFFEE_LIGHT),
        "violet": (VIOLET_DARK, VIOLET_LIGHT),
    }
